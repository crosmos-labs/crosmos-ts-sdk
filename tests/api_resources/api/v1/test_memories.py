...
class TestMemories:
    ...
    def test_method_list(self, client: Crosmos) -> None:
        memory = client.api.v1.memories.list(
            space_id=0,
        )
    ...
    def test_raw_response_list(self, client: Crosmos) -> None:
        response = client.api.v1.memories.with_raw_response.list(
            space_id=0,
        )
    ...
    def test_streaming_response_list(self, client: Crosmos) -> None:
        with client.api.v1.memories.with_streaming_response.list(
            space_id=0,
        ) as response:
    ...
    def test_streaming_response_get(self, client: Crosmos) -> None:
        with client.api.v1.memories.with_streaming_response.get(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncMemories:
    ...
    async def test_method_list(self, async_client: AsyncCrosmos) -> None:
        memory = await async_client.api.v1.memories.list(
            space_id=0,
        )
        assert_matches_type(MemoryListResponse, memory, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCrosmos) -> None:
        response = await async_client.api.v1.memories.with_raw_response.list(
            space_id=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCrosmos) -> None:
        async with async_client.api.v1.memories.with_streaming_response.list(
            space_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_get(self, async_client: AsyncCrosmos) -> None:
        async with async_client.api.v1.memories.with_streaming_response.get(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
