...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    params: ['limit?: number;', 'name?: string;', 'offset?: number;'],
    response:
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/spaces',
      },
    },
  },
  {
    ...
    description: 'Create memory space',
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/spaces/$SPACE_UUID',
      },
    },
  },
  {
    ...
    description: 'Delete memory space (owner/admin only)',
  ...
  },
  {
    ...
    params: [
      "sources: { content: string; content_type?: 'text' | 'markdown' | 'conversation' | 'html' | 'json' | 'pdf' | 'image' | 'audio' | 'video'; meta?: object; role?: string; visibility?: 'private' | 'org'; }[];",
      'space_id: string;',
    ],
    response:
      "{ job_id: string; jobs: { job_id: string; source_ids: string[]; }[]; source_ids: string[]; status: 'pending'; }",
    markdown:
      "## ingest\n\n`client.sources.ingest(sources: { content: string; content_type?: 'text' | 'markdown' | 'conversation' | 'html' | 'json' | 'pdf' | 'image' | 'audio' | 'video'; meta?: object; role?: string; visibility?: 'private' | 'org'; }[], space_id: string): { job_id: string; jobs: object[]; source_ids: string[]; status: 'pending'; }`\n\n**post** `/api/v1/sources`\n\nEnqueue a batch of sources for asynchronous ingestion. Fire-and-forget: returns 202 with a job_id you can poll via GET /jobs/{job_id}.\n\n### Parameters\n\n- `sources: { content: string; content_type?: 'text' | 'markdown' | 'conversation' | 'html' | 'json' | 'pdf' | 'image' | 'audio' | 'video'; meta?: object; role?: string; visibility?: 'private' | 'org'; }[]`\n\n- `space_id: string`\n\n### Returns\n\n- `{ job_id: string; jobs: { job_id: string; source_ids: string[]; }[]; source_ids: string[]; status: 'pending'; }`\n\n  - `job_id: string`\n  - `jobs: { job_id: string; source_ids: string[]; }[]`\n  - `source_ids: string[]`\n  - `status: 'pending'`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst ingestAccepted = await client.sources.ingest({ sources: [{ content: 'x' }], space_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(ingestAccepted);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ count: number; sources: { id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }[]; total: number; }",
    markdown:
      "## list\n\n`client.sources.list(content_type?: string, extraction_status?: 'pending' | 'processing' | 'completed' | 'failed', limit?: number, offset?: number, space_id?: string, space_uuid?: string): { count: number; sources: object[]; total: number; }`\n\n**get** `/api/v1/sources`\n\nList Sources\n\n### Parameters\n\n- `content_type?: string`\n\n- `extraction_status?: 'pending' | 'processing' | 'completed' | 'failed'`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ count: number; sources: { id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }[]; total: number; }`\n\n  - `count: number`\n  - `sources: { id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }[]`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst sourceList = await client.sources.list();\n\nconsole.log(sourceList);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/sources',
      },
    },
  },
  {
    ...
    params: ['source_uuid: string;', 'space_id?: string;', 'space_uuid?: string;'],
    response:
      "{ id: string; content: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }",
    markdown:
      "## get\n\n`client.sources.get(source_uuid: string, space_id?: string, space_uuid?: string): { id: string; content: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }`\n\n**get** `/api/v1/sources/{source_uuid}`\n\nGet Source\n\n### Parameters\n\n- `source_uuid: string`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ id: string; content: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }`\n\n  - `id: string`\n  - `content: string`\n  - `content_type: string`\n  - `created_at: string`\n  - `extraction_status: 'pending' | 'processing' | 'completed' | 'failed'`\n  - `meta: object`\n  - `space_id: string`\n  - `token_count: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst source = await client.sources.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(source);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/sources/$SOURCE_UUID',
      },
    },
  },
  {
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.memories.list(limit?: number, memory_type?: 'viewpoint' | 'semantic' | 'episode' | 'inference', offset?: number, order?: 'asc' | 'desc', sort_by?: 'created_at' | 'importance_score' | 'event_time' | 'last_accessed_at' | 'access_frequency', space_id?: string, space_uuid?: string): { count: number; memories: memory[]; }`\n\n**get** `/api/v1/memories`\n\nList memories\n\n### Parameters\n\n- `limit?: number`\n\n- `memory_type?: 'viewpoint' | 'semantic' | 'episode' | 'inference'`\n\n- `offset?: number`\n\n- `order?: 'asc' | 'desc'`\n\n- `sort_by?: 'created_at' | 'importance_score' | 'event_time' | 'last_accessed_at' | 'access_frequency'`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ count: number; memories: { id: string; access_frequency: number; content: string; created_at: string; event_time: string; forgotten_at: string; importance_score: number; last_accessed_at: string; memory_type: string; meta: object; space_id: string; }[]; }`\n\n  - `count: number`\n  - `memories: { id: string; access_frequency: number; content: string; created_at: string; event_time: string; forgotten_at: string; importance_score: number; last_accessed_at: string; memory_type: string; meta: object; space_id: string; }[]`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst memoryList = await client.memories.list();\n\nconsole.log(memoryList);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/memories',
      },
    },
  },
  {
    ...
    params: ['memory_uuid: string;', 'space_id?: string;', 'space_uuid?: string;'],
    response:
    ...
    markdown:
      "## get\n\n`client.memories.get(memory_uuid: string, space_id?: string, space_uuid?: string): { id: string; access_frequency: number; content: string; created_at: string; event_time: string; forgotten_at: string; importance_score: number; last_accessed_at: string; memory_type: string; meta: object; space_id: string; }`\n\n**get** `/api/v1/memories/{memory_uuid}`\n\nGet memory\n\n### Parameters\n\n- `memory_uuid: string`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ id: string; access_frequency: number; content: string; created_at: string; event_time: string; forgotten_at: string; importance_score: number; last_accessed_at: string; memory_type: string; meta: object; space_id: string; }`\n\n  - `id: string`\n  - `access_frequency: number`\n  - `content: string`\n  - `created_at: string`\n  - `event_time: string`\n  - `forgotten_at: string`\n  - `importance_score: number`\n  - `last_accessed_at: string`\n  - `memory_type: string`\n  - `meta: object`\n  - `space_id: string`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst memory = await client.memories.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(memory);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/memories/$MEMORY_UUID',
      },
    },
  },
  {
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.entities.list(entity_type?: string, limit?: number, offset?: number, order?: 'asc' | 'desc', q?: string, sort_by?: 'name' | 'edge_count' | 'created_at', space_id?: string, space_uuid?: string): { entities: entity[]; total: number; }`\n\n**get** `/api/v1/entities`\n\nList entities\n\n### Parameters\n\n- `entity_type?: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `order?: 'asc' | 'desc'`\n\n- `q?: string`\n\n- `sort_by?: 'name' | 'edge_count' | 'created_at'`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ entities: { id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }[]; total: number; }`\n\n  - `entities: { id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }[]`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst entityList = await client.entities.list();\n\nconsole.log(entityList);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/entities',
      },
    },
  },
  {
    ...
    params: ['entity_uuid: string;', 'space_id?: string;', 'space_uuid?: string;'],
    response:
      '{ id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }',
    markdown:
      "## get\n\n`client.entities.get(entity_uuid: string, space_id?: string, space_uuid?: string): object`\n\n**get** `/api/v1/entities/{entity_uuid}`\n\nGet entity\n\n### Parameters\n\n- `entity_uuid: string`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst entityDetail = await client.entities.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(entityDetail);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/entities/$ENTITY_UUID',
      },
    },
  },
  {
    ...
    response: "{ job_id: string; source_id: string; status: 'pending'; }",
    markdown:
      "## ingest\n\n`client.conversations.ingest(messages: { content: string; role: string; }[], space_id: string, meta?: object, session_date?: string, session_id?: string, visibility?: 'private' | 'org'): { job_id: string; source_id: string; status: 'pending'; }`\n\n**post** `/api/v1/conversations`\n\nIngest a multi-turn conversation. The conversation is stored as a single source and segmented at ingestion into windows of 4 turns; each window is extracted independently with the prior window as lookback context for pronoun resolution.\n\n### Parameters\n\n- `messages: { content: string; role: string; }[]`\n\n- `space_id: string`\n\n- `meta?: object`\n\n- `session_date?: string`\n\n- `session_id?: string`\n\n- `visibility?: 'private' | 'org'`\n\n### Returns\n\n- `{ job_id: string; source_id: string; status: 'pending'; }`\n\n  - `job_id: string`\n  - `source_id: string`\n  - `status: 'pending'`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst ingestConversation = await client.conversations.ingest({ messages: [{ content: 'x', role: 'x' }], space_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(ingestConversation);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ completed_at: string; created_at: string; error_message: string; job_id: string; result: { edge_count: number; entity_count: number; failed_source_ids: number[]; memory_count: number; source_ids: number[]; tokens_used: number; error_message?: string; source_errors?: object; }; source_ids: number[]; started_at: string; status: 'pending' | 'processing' | 'completed' | 'partial' | 'failed' | 'cancelled'; }",
    markdown:
      "## get_status\n\n`client.jobs.getStatus(job_id: string): { completed_at: string; created_at: string; error_message: string; job_id: string; result: object; source_ids: number[]; started_at: string; status: 'pending' | 'processing' | 'completed' | 'partial' | 'failed' | 'cancelled'; }`\n\n**get** `/api/v1/jobs/{job_id}`\n\nGet Job\n\n### Parameters\n\n- `job_id: string`\n\n### Returns\n\n- `{ completed_at: string; created_at: string; error_message: string; job_id: string; result: { edge_count: number; entity_count: number; failed_source_ids: number[]; memory_count: number; source_ids: number[]; tokens_used: number; error_message?: string; source_errors?: object; }; source_ids: number[]; started_at: string; status: 'pending' | 'processing' | 'completed' | 'partial' | 'failed' | 'cancelled'; }`\n\n  - `completed_at: string`\n  - `created_at: string`\n  - `error_message: string`\n  - `job_id: string`\n  - `result: { edge_count: number; entity_count: number; failed_source_ids: number[]; memory_count: number; source_ids: number[]; tokens_used: number; error_message?: string; source_errors?: object; }`\n  - `source_ids: number[]`\n  - `started_at: string`\n  - `status: 'pending' | 'processing' | 'completed' | 'partial' | 'failed' | 'cancelled'`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst response = await client.jobs.getStatus('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'from crosmos import Crosmos\n\nclient = Crosmos()\nresponse = client.jobs.get_status(\n    "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(response.job_id)',
      },
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/jobs/$JOB_ID',
      },
    },
  },
  {
    ...
    response:
      "{ period_end: string; period_start: string; plan: 'free' | 'developer' | 'pro' | 'enterprise'; queries: { limit: number; remaining: number; used: number; }; rate_limit_per_day: number; rate_limit_rpm: number; spaces: { limit: number; remaining: number; used: number; }; tokens: { limit: number; remaining: number; used: number; }; }",
    markdown:
      "## get\n\n`client.usage.get(end_date?: string, start_date?: string): { period_end: string; period_start: string; plan: 'free' | 'developer' | 'pro' | 'enterprise'; queries: object; rate_limit_per_day: number; rate_limit_rpm: number; spaces: object; tokens: object; }`\n\n**get** `/api/v1/usage`\n\nGet org usage\n\n### Parameters\n\n- `end_date?: string`\n\n- `start_date?: string`\n\n### Returns\n\n- `{ period_end: string; period_start: string; plan: 'free' | 'developer' | 'pro' | 'enterprise'; queries: { limit: number; remaining: number; used: number; }; rate_limit_per_day: number; rate_limit_rpm: number; spaces: { limit: number; remaining: number; used: number; }; tokens: { limit: number; remaining: number; used: number; }; }`\n\n  - `period_end: string`\n  - `period_start: string`\n  - `plan: 'free' | 'developer' | 'pro' | 'enterprise'`\n  - `queries: { limit: number; remaining: number; used: number; }`\n  - `rate_limit_per_day: number`\n  - `rate_limit_rpm: number`\n  - `spaces: { limit: number; remaining: number; used: number; }`\n  - `tokens: { limit: number; remaining: number; used: number; }`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst usage = await client.usage.get();\n\nconsole.log(usage);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://api.crosmos.dev/api/v1/usage',
      },
    },
  },
];
