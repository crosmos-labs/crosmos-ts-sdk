...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    markdown:
      "## list\n\n`client.spaces.list(limit?: number, name?: string, offset?: number): { id: string; created_at: string; description: string; meta: object; name: string; org_id: string; updated_at: string; }`\n\n**get** `/api/v1/spaces`\n\nPass ?name= to resolve a space by its name (returns 0 or 1 since names are unique per org).\n\n### Parameters\n\n- `limit?: number`\n\n- `name?: string`\n\n- `offset?: number`\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; meta: object; name: string; org_id: string; updated_at: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `meta: object`\n  - `name: string`\n  - `org_id: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\n// Automatically fetches more pages as needed.\nfor await (const space of client.spaces.list()) {\n  console.log(space);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }",
    markdown:
      "## list\n\n`client.sources.list(content_type?: string, extraction_status?: 'pending' | 'processing' | 'completed' | 'failed', limit?: number, offset?: number, space_id?: string, space_uuid?: string): { id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }`\n\n**get** `/api/v1/sources`\n\nList Sources\n\n### Parameters\n\n- `content_type?: string`\n\n- `extraction_status?: 'pending' | 'processing' | 'completed' | 'failed'`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ id: string; content_preview: string; content_type: string; created_at: string; extraction_status: 'pending' | 'processing' | 'completed' | 'failed'; meta: object; space_id: string; token_count: number; updated_at: string; }`\n\n  - `id: string`\n  - `content_preview: string`\n  - `content_type: string`\n  - `created_at: string`\n  - `extraction_status: 'pending' | 'processing' | 'completed' | 'failed'`\n  - `meta: object`\n  - `space_id: string`\n  - `token_count: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\n// Automatically fetches more pages as needed.\nfor await (const source of client.sources.list()) {\n  console.log(source);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.entities.list(entity_type?: string, limit?: number, offset?: number, order?: 'asc' | 'desc', q?: string, sort_by?: 'name' | 'edge_count' | 'created_at', space_id?: string, space_uuid?: string): { id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }`\n\n**get** `/api/v1/entities`\n\nList entities\n\n### Parameters\n\n- `entity_type?: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `order?: 'asc' | 'desc'`\n\n- `q?: string`\n\n- `sort_by?: 'name' | 'edge_count' | 'created_at'`\n\n- `space_id?: string`\n\n- `space_uuid?: string`\n\n### Returns\n\n- `{ id: string; created_at: string; edge_count: number; entity_type: string; name: string; space_id: string; updated_at: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `edge_count: number`\n  - `entity_type: string`\n  - `name: string`\n  - `space_id: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\n// Automatically fetches more pages as needed.\nfor await (const entity of client.entities.list()) {\n  console.log(entity);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## get\n\n`client.usage.get(end_date?: string, start_date?: string): { period_end: string; period_start: string; plan: 'free' | 'developer' | 'pro' | 'enterprise'; queries: usage_metric; rate_limit_per_day: number; rate_limit_rpm: number; spaces: usage_metric; tokens: usage_metric; }`\n\n**get** `/api/v1/usage`\n\nGet org usage\n\n### Parameters\n\n- `end_date?: string`\n\n- `start_date?: string`\n\n### Returns\n\n- `{ period_end: string; period_start: string; plan: 'free' | 'developer' | 'pro' | 'enterprise'; queries: { limit: number; remaining: number; used: number; }; rate_limit_per_day: number; rate_limit_rpm: number; spaces: { limit: number; remaining: number; used: number; }; tokens: { limit: number; remaining: number; used: number; }; }`\n\n  - `period_end: string`\n  - `period_start: string`\n  - `plan: 'free' | 'developer' | 'pro' | 'enterprise'`\n  - `queries: { limit: number; remaining: number; used: number; }`\n  - `rate_limit_per_day: number`\n  - `rate_limit_rpm: number`\n  - `spaces: { limit: number; remaining: number; used: number; }`\n  - `tokens: { limit: number; remaining: number; used: number; }`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst usage = await client.usage.get();\n\nconsole.log(usage);\n```",
    perLanguage: {
      typescript: {
