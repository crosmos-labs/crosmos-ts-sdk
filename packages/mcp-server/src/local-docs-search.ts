...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ count: number; sources: { id: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; content_preview?: string; meta?: object; }[] | { id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }[]; total?: number; }',
    markdown:
      "## list\n\n`client.sources.list(content_type?: string, extraction_status?: string, limit?: number, offset?: number, space_id?: string): { count: number; sources: object[] | source[]; total?: number; }`\n\n**get** `/api/v1/sources`\n\nList sources in the caller's org, sorted by created_at desc.\n\nIf space_id is provided, returns only sources in that space.\nOtherwise, returns sources across all spaces in the org.\n\n### Parameters\n\n- `content_type?: string`\n\n- `extraction_status?: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `space_id?: string`\n\n### Returns\n\n- `{ count: number; sources: { id: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; content_preview?: string; meta?: object; }[] | { id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }[]; total?: number; }`\n\n  - `count: number`\n  - `sources: { id: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; content_preview?: string; meta?: object; }[] | { id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst sourceList = await client.sources.list();\n\nconsole.log(sourceList);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }',
    markdown:
      "## get\n\n`client.sources.get(source_uuid: string, space_uuid: string): { id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }`\n\n**get** `/api/v1/sources/{source_uuid}`\n\nGet a source by UUID.\n\n### Parameters\n\n- `source_uuid: string`\n\n- `space_uuid: string`\n\n### Returns\n\n- `{ id: string; content: string; content_type: string; created_at: string; extraction_status: string; sequence: number; space_id: string; token_count: number; updated_at: string; meta?: object; }`\n\n  - `id: string`\n  - `content: string`\n  - `content_type: string`\n  - `created_at: string`\n  - `extraction_status: string`\n  - `sequence: number`\n  - `space_id: string`\n  - `token_count: number`\n  - `updated_at: string`\n  - `meta?: object`\n\n### Example\n\n```typescript\nimport Crosmos from 'crosmos';\n\nconst client = new Crosmos();\n\nconst source = await client.sources.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { space_uuid: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(source);\n```",
    perLanguage: {
      typescript: {
