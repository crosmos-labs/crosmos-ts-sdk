...
from .....types.api.v1.auth import key_create_params
from .....types.api.v1.auth.key_list_response import KeyListResponse
from .....types.api.v1.auth.key_create_response import KeyCreateResponse
...
class KeysResource(SyncAPIResource):
    ...
    def revoke(
        ...
        *,
        ...
        return self._delete(
            path_template("/api/v1/auth/keys/{key_id}", key_id=key_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
